            ...
            <div className="mb-4 flex items-center justify-between gap-4">
                ...
                <div className="relative flex-1">
                    ...
                    <Input
                        ...
                        value={
                            (table.getColumn("businessAddress")?.getFilterValue() as string) ?? ""
                        }
                        onChange={(event) =>
                            table.getColumn("businessAddress")?.setFilterValue(event.target.value)
                        }
                        className="pl-10"
                    />
                </div>
                <div className="relative flex-1">
                    ...
                    <Input
                        ...
                        onChange={(event) =>
                            table.getColumn("businessEmail")?.setFilterValue(event.target.value)
                        }
                        className="pl-10"
                    />
                </div>
